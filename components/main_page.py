...
def main_page():
    ...
    st.write("""
    KeenAI harnesses cutting-edge AI to transform your natural language text into powerful SQL queries, delivering your database results in seconds without you having to write a single SQL statement yourself.
    """)
